...
export const IMAGES_DATA = {
    OUTWEAR: {
        DUSTER_COAT: outwearDusterCoat,
        FROSTER_COAT: outwearFrosterCoat,
        FULL_TRENCH_COAT: outwearFullTrenchCoat,
        MACKINTOSH_COAT: outwearMackintoshRaincoatCoat,
        ULSTERETTE: outwearUlsterette,
    },
};
